...
// Generated from `/usr/local/resin_system.mqq.com/webapps/communication/taf/upload/starsun/qmf_protocal_define.jce'
// **********************************************************************
...
namespace QMF_PROTOCAL
{
    ...
    public:
        ...
        static string MD5()
        {
            return "85a96faf121399b1874ff7e0abfc2130";
        }
        QmfUpstream()
        :Seq(0),Appid(0),Uin(0),Qua(""),ServiceCmd(""),DeviceInfo(""),flag(0),sessionID(0)
        {
        }
        void resetDefautlt()
        {
        ...
        ostream& displaySimple(ostream& _os, int _level=0) const
        {
            ...
            _ds.displaySimple(BusiControl, false);
            return _os;
        }
        int Encode(uint8_t * pui_buff, int32_t * pi_buff_len, pdu_protocol_header * pdu_header)
        {
    ...
    {
        return l.Seq == r.Seq && l.Appid == r.Appid && l.Uin == r.Uin && l.Qua == r.Qua && l.ServiceCmd == r.ServiceCmd && l.DeviceInfo == r.DeviceInfo && l.Token == r.Token && l.IpInfo == r.IpInfo && l.BusiBuff == r.BusiBuff && l.Extra == r.Extra && l.flag == r.flag && l.sessionID == r.sessionID && l.retryinfo == r.retryinfo && l.BusiControl == r.BusiControl;
    }
    inline bool operator!=(const QmfUpstream&l, const QmfUpstream&r)
    {
        return !(l == r);
    ...
    public:
        ...
        static string MD5()
        {
            return "5a7520c90a44cd3f27cf0320938b2696";
        }
        QmfDownstream()
        :Seq(0),Uin(0),WnsCode(0),BizCode(0),ServiceCmd(""),WnsErrorMsg("")
        {
        }
        void resetDefautlt()
        {
        ...
        ostream& displaySimple(ostream& _os, int _level=0) const
        {
            ...
            _ds.displaySimple(BusiBuff, true);
            _ds.displaySimple(Extra, true);
            _ds.displaySimple(WnsErrorMsg, false);
            return _os;
        }
        int Encode(uint8_t * pui_buff, int32_t * pi_buff_len, pdu_protocol_header * pdu_header)
        {
    ...
    {
        return l.Seq == r.Seq && l.Uin == r.Uin && l.WnsCode == r.WnsCode && l.BizCode == r.BizCode && l.ServiceCmd == r.ServiceCmd && l.BusiBuff == r.BusiBuff && l.Extra == r.Extra && l.WnsErrorMsg == r.WnsErrorMsg;
    }
    inline bool operator!=(const QmfDownstream&l, const QmfDownstream&r)
    {
        return !(l == r);
